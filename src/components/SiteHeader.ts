...
export default defineComponent({
  ...
  props: {
    activePage: {
      type: String as PropType<SitePageId | 'home'>,
      default: 'home',
    },
    mode: {
  ...
  setup(props, { emit }) {
    ...
    const navigate = (page: SitePageId | 'home') => {
      menuOpen.value = false;
      emit('navigate', page);
    };
    ...
    <header class="site-header top-nav glass-panel" :class="{ 'content-nav': mode === 'content' }">
      ...
      <Transition name="menu-fade">
        <nav v-if="menuOpen" class="mobile-site-nav" aria-label="行動版主要導覽">
          <a href="#/methodology" @click.prevent="navigate('methodology')"><span>推薦方法</span><b>01</b></a>
          <a href="#/about" @click.prevent="navigate('about')"><span>關於 TRIP SYNC</span><b>02</b></a>
          <a href="#/contact" @click.prevent="navigate('contact')"><span>聯絡與更正</span><b>03</b></a>
